...
Version  : 22.12.3
Release  : 53
URL      : https://download.kde.org/stable/release-service/22.12.3/src/kldap-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kldap-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kldap-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kldap-22.12.3
cd %{_builddir}/kldap-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677789525
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Ldap.so.5.22.3
