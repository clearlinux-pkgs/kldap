...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kldap-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kldap-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kldap-22.12.1
cd %{_builddir}/kldap-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673297273
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Ldap.so.5.22.1
