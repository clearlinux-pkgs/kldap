...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kldap-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kldap-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kldap-23.08.2
cd %{_builddir}/kldap-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697251920
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5Ldap.so.5.24.2
/V3/usr/lib64/qt5/plugins/kf5/kio/ldap.so
/usr/lib64/libKPim5Ldap.so.5
/usr/lib64/libKPim5Ldap.so.5.24.2
