...
Version  : 23.04.2
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.04.2/src/kldap-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/kldap-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/kldap-23.04.2.tar.xz.sig
...
%prep
%setup -q -n kldap-23.04.2
cd %{_builddir}/kldap-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686519858
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5Ldap.so.5.23.2
/V3/usr/lib64/qt5/plugins/kf5/kio/ldap.so
/usr/lib64/libKPim5Ldap.so.5
/usr/lib64/libKPim5Ldap.so.5.23.2
