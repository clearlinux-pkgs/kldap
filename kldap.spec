...
Version  : 22.04.3
Release  : 44
URL      : https://download.kde.org/stable/release-service/22.04.3/src/kldap-22.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kldap-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kldap-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kldap-22.04.3
cd %{_builddir}/kldap-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657568928
mkdir -p clr-build
pushd clr-build
...
export CXXFLAGS="$CXXFLAGS -O3 -ffat-lto-objects -flto=auto -std=gnu++98"
%cmake ..
make  %{?_smp_mflags}
popd
...
cp %{_builddir}/kldap-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kldap/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/kldap-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kldap/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kldap-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kldap/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kldap-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kldap/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kldap-22.04.3/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/kldap/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
cp %{_builddir}/kldap-22.04.3/README.md.license %{buildroot}/usr/share/package-licenses/kldap/cadc9e08cb956c041f87922de84b9206d9bbffb2
cp %{_builddir}/kldap-22.04.3/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/kldap/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
%find_lang kio_ldap
...
/usr/lib64/libKF5Ldap.so.5.20.3
